...
REPO_NAME = "yajatyadav/whiteboard"  # Name of the output dataset, also used for the Hugging Face Hub
LANGUAGE_INSTRUCTION = "wipe the whiteboard"
...
def main(data_dir: str, *, push_to_hub: bool = False):
    ...
    for episode_path in tqdm(episode_paths, desc="Converting episodes"):
        ...
        language_instruction = language_annotations.get(episode_id, {"language_instruction1": LANGUAGE_INSTRUCTION})[
...
class RecordedMultiCameraWrapper:
    def __init__(self, recording_folderpath, camera_kwargs={}):  # noqa: B006
        ...
        for f in all_filepaths:
            ...
            ## TODO(YY): hax to fix some serial number discrepancy
