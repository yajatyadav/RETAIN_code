...
from openpi.training.rlds_dataloader import traj_transforms
from openpi.training.rlds_dataloader.data_utils import (
    allocate_threads,
    get_dataset_statistics,
    pprint_data_mixture,
    tree_map,   
)
import openpi.training.rlds_dataloader.obs_transforms as obs_transforms
    ...
    *,
    ...
    def restructure(traj):
        ...
        traj = {
            ...
            # "success": tf.repeat(success, traj_len),
        }
...
def make_interleaved_dataset(
    ...
    *,
    ...
    for dataset_kwargs in dataset_kwargs_list:
        ...
        print("THIS DATASET HAS NUM_TRAJECTORIES", dataset_statistics["num_trajectories"], " AND NUM_TRANSITIONS", dataset_statistics["num_transitions"])
